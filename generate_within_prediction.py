    ...
    for rel in test_rel:
        ...
        for filename, df in tqdm(test_df.groupby('filename')):
            ...
            with torch.no_grad():
                ...
                line_att_weight = line_att_weight / torch.sum(line_att_weight, dim=1, keepdim=True)
...
def main():
    ...
    arg.add_argument('-prediction_dir', type=str, default='output/prediction/BARLineDP/within-release/',
