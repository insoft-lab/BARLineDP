...
class BARLineDP(nn.Module):
    ...
    def forward(self, code_tensor):
        ...
        # construct features that incorporate code line semantics, line-level contexts and local interation information
